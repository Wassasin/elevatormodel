...
\begin{document}
	...
	For this analysis we wrote a tool that generates a model for a specific number of floor and users, and measures the execution time of that model in NuSMV2. If the model checker runs for more than 2 minutes, the attempt is terminated. Below we enumerate the execution time in seconds for each instance of a model.
	...
	The following properties have all successfully been verified.
